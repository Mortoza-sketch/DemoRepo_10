...
@CucumberOptions(
features = "C:\\Users\\tamji\\eclipse-workspace\\CucumberDemo_P1\\src\\main\\java\\Features\\loginDDTP1.feature", // The path of the Feature files
glue={"LoginDDTStepDefinition"}, //	The path of the step definition files
...
public class TestRunnerLoginDDT {
