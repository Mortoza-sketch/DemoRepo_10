...
@CucumberOptions(
features = "C:\\Users\\tamji\\eclipse-workspace\\CucumberDemo_P1\\src\\main\\java\\Features\\contacts.feature", // The path of the Feature files
glue={"ContactsStepDefinition"}, //	The path of the step definition files
...
public class TestRunnerContacts {
