package TaggedHooksStepDefinition;
...
public static WebDriver driver;
    ...
    //Global Hooks --> will be applied for all Scenarios
	@Before(order=1)
	...
	driver.get("https://ui.cogmento.com/");
	Thread.sleep(3000);
	driver.findElement(By.name("email")).sendKeys("abcdtesting4@gmail.com");
	driver.findElement(By.name("password")).sendKeys("AbcD1234");
	Thread.sleep(2000);
	WebElement loginBtn = driver.findElement(By.xpath("//div[@class='ui fluid large blue submit button']"));	   
    JavascriptExecutor js = (JavascriptExecutor)driver;
	...
	//Local Hooks --> will be executed only for First Scenario
	@Before("@First")
	public void beforeFirst() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
	//Local Hooks --> will be executed only for First Scenario
	@After("@First")
	public void afterFirst() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
	//Local Hooks --> will be executed only for Second Scenario
	@Before("@Second")
	public void beforeSecond() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
	
	@After("@Second")
	public void afterSecond() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
	//Local Hooks --> will be executed only for Third Scenario
	@Before("@Third")
	public void beforeThird() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
	
	@After("@Third")
	public void afterThird() throws InterruptedException{
	driver.navigate().to("https://ui.cogmento.com/");
	Thread.sleep(2000);			
	}
